...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="relative mt-10 lg:mt-20 -ml-[30px] -mr-[30px] sm:mx-0">
        <Image
        ...
        />
        <div className="relative z-10 p-[30px] pt-10 sm:pt-20 lg:pb-10 xl:min-h-[500px] xl:px-10 2xl:px-20">
          ...
          <div className="relative mt-10 lg:mt-20 space-y-5 rounded-40 bg-white px-6 pb-8 pt-10 lg:flex lg:flex-wrap lg:items-center lg:gap-5 lg:space-y-0 xl:h-20 xl:flex-nowrap xl:py-0 xl:pr-3 xl:pl-10 shadow-md">
